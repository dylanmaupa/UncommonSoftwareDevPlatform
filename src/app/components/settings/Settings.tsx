              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-[#6B7280]">
                    Edit your nickname from your profile page
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button
                      variant="destructive"
                      className="flex-shrink-0 bg-[#EF4444] hover:bg-[#DC2626]"
                    >
          ...
          <Card className="border-[rgba(0,0,0,0.08)] bg-gradient-to-br from-[#0747a1]/5 to-[#8B5CF6]/5">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-[#6B7280] mb-3">
                A free, open-access coding education platform. All courses and features are
                completely free with no premium tiers or paywalls.
              </p>
              <p className="text-xs text-[#6B7280]">
