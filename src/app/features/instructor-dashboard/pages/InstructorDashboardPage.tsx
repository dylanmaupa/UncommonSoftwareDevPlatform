    ...
    <Link to={href} className="block">
      <Card className="relative h-full overflow-hidden rounded-2xl border-border bg-card">
        <CardContent className="space-y-4 p-4">
          ...
          <div>
            <p className="text-4xl font-semibold leading-none text-foreground">0</p>
            <p className="mt-2.5 flex items-center gap-1 text-sm text-muted-foreground">
              {label}
              <LuArrowUpRight className={`h-3.5 w-3.5 ${arrowClassName}`} />
            </p>
          </div>

          <Icon className="pointer-events-none absolute -bottom-3 right-4 h-20 w-20 text-muted-foreground/10" />
        </CardContent>
      </Card>
    </Link>
  );
...
export default function InstructorDashboardPage() {
  ...
  return (
    <div className="p-3 sm:p-4 lg:p-5">
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_280px] xl:grid-cols-[minmax(0,1fr)_300px]">
        <div className="space-y-3">
          <div className="flex flex-wrap items-center gap-2.5 rounded-2xl border border-border bg-sidebar p-2.5">
            <div className="order-1 relative w-full min-w-0 sm:min-w-[220px] sm:flex-1">
              ...
              <input
                ...
                className="h-9 w-full rounded-full border border-border bg-card pl-9 pr-3 text-sm text-foreground outline-none"
              />
            </div>
            <div className="order-2 flex items-center gap-2">
              <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full border border-border bg-card text-muted-foreground">
          ...
          <Card className="overflow-hidden rounded-2xl border-border bg-primary">
            <CardContent className="p-4 sm:p-5">
              ...
              <h2 className="heading-font mt-2 max-w-md text-xl leading-tight text-white sm:text-2xl">
              ...
              <Button asChild className="mt-4 h-8 rounded-full bg-white px-4 text-foreground hover:bg-white/90">
                <Link to="/instructor/hub">
                  Open Hub
                  <LuChevronRight className="ml-1.5 h-4 w-4" />
                </Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 gap-2.5 xl:grid-cols-2">
            <Card className="rounded-2xl border-border">
              <CardContent className="p-0">
                <div className="flex items-center justify-between border-b border-border px-4 py-3">
                  <div className="flex items-center gap-2.5">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10 text-primary">
                      <LuUsers className="h-4.5 w-4.5" />
                    </div>
                    <h2 className="heading-font text-xl text-foreground">Your Classes</h2>
                  </div>

                  <Link to="/instructor/hub-controls">
                    <Button className="h-9 rounded-xl px-3.5 text-sm">
                ...
                <div className="p-4">
                  <div className="rounded-2xl border border-dashed border-border bg-sidebar px-4 py-8 text-center">
                    <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-card text-muted-foreground">
                      <LuUsers className="h-5 w-5" />
                    </div>
                    <p className="mt-3 text-2xl text-foreground">No classes yet</p>
                    <p className="mt-1.5 text-sm text-muted-foreground">Create your first class to get started.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl border-border">
              <CardContent className="p-0">
                <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-border px-4 py-3">
                  <div className="flex items-center gap-2.5">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10 text-primary">
                      <LuClock3 className="h-4.5 w-4.5" />
                    </div>
                    <h2 className="heading-font text-xl text-foreground">Timeline</h2>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link to="/instructor/exercises">
                      <Button variant="secondary" className="h-9 rounded-xl px-3.5 text-sm">
                        <LuPlus className="h-4 w-4" />
                        New
                      </Button>
                    </Link>
                ...
                <div className="p-4">
                  <div className="rounded-2xl border border-dashed border-border bg-sidebar px-4 py-8 text-center">
                    ...
                    <p className="mt-3 text-2xl text-foreground">No {timelineFilter} items</p>
        ...
        <div className="space-y-3">
          <Card className="rounded-2xl border-border">
            <CardContent className="space-y-3 p-3">
              <div className="flex items-center justify-between">
                <h3 className="text-sm text-foreground heading-font">Profile Overview</h3>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-sm text-foreground">Good Morning {instructor.fullName}</p>
              ...
              <div className="rounded-xl bg-secondary p-2.5">
                <div className="mb-2 flex items-end gap-1.5">
                  ...
                  <div className="h-9 w-6 rounded-md bg-primary/70" />
                  <div className="h-7 w-6 rounded-md bg-primary/40" />
                  <div className="h-10 w-6 rounded-md bg-primary" />
                  <div className="h-6 w-6 rounded-md bg-primary/30" />
                </div>
          ...
          <Card className="rounded-2xl border-border">
            <CardContent className="space-y-2.5 p-3">
              <div className="flex items-center justify-between">
                <h3 className="text-sm text-foreground heading-font">Quick Access</h3>
                <LuTarget className="h-4 w-4 text-muted-foreground" />
              </div>
              <Link to="/instructor/students" className="flex items-center justify-between rounded-xl bg-sidebar p-2">
                <span className="text-sm text-foreground">Students</span>
                <LuChevronRight className="h-4 w-4 text-muted-foreground" />
              </Link>
              <Link to="/instructor/exercises" className="flex items-center justify-between rounded-xl bg-sidebar p-2">
                <span className="text-sm text-foreground">Exercises</span>
                <LuChevronRight className="h-4 w-4 text-muted-foreground" />
              </Link>
              <Link to="/instructor/projects" className="flex items-center justify-between rounded-xl bg-sidebar p-2">
                <span className="text-sm text-foreground">Projects</span>
                <LuChevronRight className="h-4 w-4 text-muted-foreground" />
              </Link>
              <Link to="/instructor/announcements" className="flex items-center justify-between rounded-xl bg-sidebar p-2">
      ...
      <Link
        ...
        className="fixed bottom-4 right-4 z-20 inline-flex items-center gap-2.5 rounded-full border border-border bg-card px-3 py-2 shadow-sm"
      >
        <span className="h-2 w-2 rounded-full bg-emerald-500" />
        <span className="text-sm text-foreground">Live Activity</span>
        <span className="rounded-full bg-sidebar px-2 py-0.5 text-xs text-foreground">0</span>
